 ...
 settings: 
  [{settings: 
   ...
   {name: "~ String",
    ...
    settings: {background: "#803D0033", foreground: "#FFFC80"}},
   {name: "~ String Punctuation",
    scope: "punctuation.definition.string -meta.tag",
    settings: {foreground: "#803D00"}},
   ...
   {name: "¢ Class",
    ...
    settings: {background: "#FF000033", foreground: "#870000"}},
   {name: "¢ Library class/type",
    scope: "support.type, support.class",
    settings: {background: "#87000033", foreground: "#FF0000"}},
   {name: "¢ Instance",
    scope: "entity.name.instance, entity.name.type.instance",
    settings: {foreground: "#FF3D44"}},
   {name: "¢ Instance.constructor",
    scope: "meta.class.instance.constructor",
    settings: {background: "#831E5133"}},
   {name: "¢ Inherited class",
    scope: "entity.other.inherited-class, entity.name.module",
    settings: {background: "#80000433", foreground: "#FF0086"}},
   {name: "¢ Class Method",
    scope: "meta.definition.method",
    settings: {foreground: "#FF0086"}},
   ...
   {name: "™ Function Call",
    ...
    settings: {foreground: "#782EC1"}},
   {name: "™ Library Function Call",
    scope: "meta.function-call support.function - variable",
    settings: {fontStyle: "", foreground: "#9D3EFF"}},
   {name: "™ Library Function Name",
    scope: "support.function",
    settings: {background: "#603F8033", foreground: "#603F80"}},
   {name: "™ Function Call Arguments Punctuation",
    ...
    settings: {fontStyle: "", foreground: "#BC80FF"}},
   {name: "™ Function Punctuation",
    ...
    settings: {fontStyle: "bold", foreground: "#BC80FF"}},
   {name: "™ Function Call Without Arguments",
    ...
    settings: {foreground: "#A88FC0"}},
   {name: "—————————————————", settings: {}},
   {name: "™ Keyword Control",
    scope: "keyword.control",
    settings: {foreground: "#F800FF"}},
   {name: "™ Keyword", scope: "keyword", settings: {}},
   {name: "™ Keyword other",
    scope: "keyword.other",
    settings: {foreground: "#7900FF"}},
   {name: "™ Regex Keyword",
   ...
   {name: "™ Keyword Operator",
    ...
    settings: {foreground: "#0000CE"}},
   {name: "™ Keyword Operator Assignment",
    scope: "keyword.operator.assignment",
    settings: {background: "#00009A33", foreground: "#0000CE"}},
   {name: "™ Keyword Operator Arithmetic",
    scope: "keyword.operator.arithmetic",
    settings: {foreground: "#2136CE"}},
   {name: "™ Keyword Operator Logical",
    scope: "keyword.operator.logical",
    settings: {background: "#00009A33", foreground: "#3759FF"}},
   {name: "™ Keyword Operator Comparison",
    scope: "keyword.operator.comparison",
    settings: {foreground: "#7C88FF"}},
   {name: "meta.class.instance.constructor keyword.operator.new",
    scope: "meta.class.instance.constructor keyword.operator.new",
    settings: {foreground: "#800043"}},
   {name: "—————————————————", settings: {}},
   {name: "✘ HTML", settings: {}},
   {name: "✘ Tag Doctype",
    scope: 
     "meta.doctype, meta.tag.sgml-declaration.doctype, meta.tag.sgml.doctype",
    settings: {background: "#333333", foreground: "#CCCCCC"}},
   ...
   {name: "✘ Tag Inline",
    ...
    settings: {background: "#803D0033", foreground: "#FF7900"}},
   ...
   {name: "✘ Tag Other",
    ...
    settings: {background: "#80000433", foreground: "#FF0007"}},
   {name: "✘ Tag Form",
    scope: "meta.tag.form, meta.tag.block.form",
    settings: {background: "#00438033", foreground: "#0086FF"}},
   {name: "✘ Tag Meta",
    scope: "meta.tag.meta",
    settings: {background: "#3C008033", foreground: "#F800FF"}},
   {name: "✘ Tag Block Head",
   ...
   {name: "M markup",
    ...
    settings: {background: "#33333333", foreground: "#FFF800"}},
   {name: "M HR",
    scope: "markup.hr",
   ...
   {name: "M bold",
    scope: "markup.bold",
    settings: {fontStyle: "bold", foreground: "#95D4FF80"}},
   ...
   {name: "M reference",
    ...
    settings: {fontStyle: "", foreground: "#0086FF"}},
   {name: "M reference name",
    scope: "entity.name.reference",
    settings: {background: "#00438033", foreground: "#00FFF8"}},
   {name: "M underline link",
    scope: 
     "meta.reference.list markup.underline.link, text.html.textile markup.underline.link",
    settings: {fontStyle: "underline", foreground: "#00FFF8"}},
   {name: "M raw block",
    scope: "markup.raw.block",
    settings: {background: "#80808040"}},
   {name: "M quote block",
    scope: "markup.quote",
   ...
   {name: "text.html.markdown markup.heading",
    ...
    settings: {fontStyle: "bold", foreground: "#000000"}},
   {name: "text.html.markdown string",
    scope: "text.html.markdown string",
    settings: {foreground: "#8A5420"}},
   {name: "—————————————————", settings: {}},
   ...
   {name: "Property Value Parens",
    ...
    settings: {fontStyle: "", foreground: "#006680"}},
   {name: "§ Pseudo-Element",
    scope: "entity.other.attribute-name.pseudo-element",
    settings: {foreground: "#4F00FF"}},
   {name: "§ Pseudo-Class",
    scope: 
   ...
   {name: "§ support.type.property-name",
    ...
    settings: {background: "#0D0D0D", fontStyle: "", foreground: "#FFFFFF"}},
   {name: "§ meta.property-value",
    scope: "meta.property-value",
    settings: {background: "#19191980", fontStyle: "", foreground: "#999999"}},
   {name: "—————————————————", settings: {}},
   ...
   {name: "L meta.footnote",
    scope: "meta.footnote",
    settings: {background: "#00008033", foreground: "#0008FF4D"}},
   ...
   {name: "◊ Source", scope: "source", settings: {fontStyle: ""}},
   {name: "◊ meta.brace.erb",
   ...
   {name: "Invalid",
    ...
    settings: 
     {background: "#FF0007", fontStyle: "bold", foreground: "#330004"}},
   {name: "Invalid Value",
    scope: "invalid.SOMETHING",
    settings: {fontStyle: "underline", foreground: "#FF3600"}},
   {name: "Syntax", scope: "meta.syntax", settings: {foreground: "#333333"}},
   {name: "comment",
    scope: "comment -comment.line",
    settings: {background: "#33333333", foreground: "#4C4C4C"}},
   {name: "comment.line",
    scope: "comment.line",
    settings: {fontStyle: "italic", foreground: "#4C4C4C"}},
   {name: "Comment Punctuation", scope: "comment punctuation", settings: {}},
   {name: "✘ HTML Comment",
   ...
   {name: "D Diff Add",
    ...
    settings: {background: "#00401E", foreground: "#40FF9A"}},
   {name: "D Diff Delete",
    scope: "markup.deleted",
    settings: {background: "#400022", foreground: "#FF40A3"}},
   {name: "D Diff Changed",
    scope: "markup.changed",
    settings: {background: "#803D00", foreground: "#FFFF55"}},
   ...
   {name: "meta.delimiter",
    ...
    settings: 
     {background: "#FFFFFF03", fontStyle: "bold", foreground: "#7F7F7F"}},
   ...
   {name: "Bold String Quotes",
    ...
    settings: {fontStyle: "bold", foreground: "#803D00"}},
   {name: "—————————————————", settings: {}},
   {name: "ß Blog Post / Email Message",
    scope: "text.blog, text.mail",
    settings: {background: "#DCDCDC", foreground: "#333333"}},
   {name: "ß Post Content",
   ...
   {name: "ß Post Header Keys",
    ...
    settings: {background: "#00FFF81A", fontStyle: "", foreground: "#06403E"}},
   {name: "ß Post Header Values",
    scope: 
     "meta.header.blog string.unquoted.blog, meta.header.mail string.unquoted",
    settings: {background: "#FFFF551A", foreground: "#803D00"}},
   {name: "—————————————————", settings: {}},
   {name: "OCAML", settings: {}},
   ...
   {name: "support.other.module",
    ...
    settings: {background: "#83000033", foreground: "#FF0000"}},
   ...
   {name: "Object Punctuation",
    ...
    settings: {fontStyle: "bold", foreground: "#0C823B"}},
   {name: "Function Punctuation",
    scope: 
   ...
   {name: "IE6",
    ...
    settings: {fontStyle: "", foreground: "#1B95E2"}},
   {name: "IE7",
    scope: 
    ...
    settings: {fontStyle: "", foreground: "#F5C034"}}],
