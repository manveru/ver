 ...
 settings: 
  [{settings: 
   ...
   {name: "Punctuation",
    ...
    settings: {fontStyle: "", foreground: "#E1EFFF"}},
   {name: "Constant",
    scope: "constant",
    settings: {fontStyle: "", foreground: "#FF628C"}},
   {name: "Entity",
    scope: "entity",
    settings: {fontStyle: "", foreground: "#FFDD00"}},
   {name: "Keyword",
    scope: "keyword",
    settings: {fontStyle: "", foreground: "#FF9D00"}},
   {name: "Storage",
    scope: "storage",
    settings: {fontStyle: "", foreground: "#FFEE80"}},
   {name: "String",
    scope: 
     "string -string.unquoted.old-plist -string.unquoted.heredoc, string.unquoted.heredoc string",
    settings: {fontStyle: "", foreground: "#3AD900"}},
   {name: "Comment",
    scope: "comment",
    settings: {fontStyle: "italic", foreground: "#0088FF"}},
   {name: "Support",
    scope: "support",
    settings: {fontStyle: "", foreground: "#80FFBB"}},
   {name: "Variable",
    scope: "variable",
    settings: {fontStyle: "", foreground: "#CCCCCC"}},
   {name: "Lang Variable",
    scope: "variable.language",
    settings: {fontStyle: "", foreground: "#FF80E1"}},
   {name: "Function Call",
    scope: "meta.function-call",
    settings: {foreground: "#FFEE80"}},
   {name: "Invalid",
    scope: "invalid",
    settings: {background: "#800F00", foreground: "#F8F8F8"}},
   {name: "Embedded Source",
    scope: "text source, string.unquoted.heredoc, source source",
    settings: {background: "#223545", fontStyle: "", foreground: "#FFFFFF"}},
   {name: "Entity inherited-class",
    scope: "entity.other.inherited-class",
    settings: {fontStyle: "italic", foreground: "#80FCFF"}},
   {name: "String embedded-source",
    scope: "string.quoted source",
    settings: {fontStyle: "", foreground: "#9EFF80"}},
   {name: "String constant",
    scope: "string constant",
    settings: {foreground: "#80FF82"}},
   {name: "String.regexp",
    scope: "string.regexp",
    settings: {foreground: "#80FFC2"}},
   {name: "String variable",
    scope: "string variable",
    settings: {foreground: "#EDEF7D"}},
   {name: "Support.function",
    scope: "support.function",
    settings: {fontStyle: "", foreground: "#FFB054"}},
   {name: "Support.constant",
    scope: "support.constant",
    settings: {fontStyle: "", foreground: "#EB939A"}},
   {name: "Exception",
    scope: "support.type.exception",
    settings: {foreground: "#FF1E00"}},
   ...
   {name: "css.class",
    ...
    settings: {foreground: "#5FE461"}},
   {name: "css property-name:",
    scope: "support.type.property-name.css",
    settings: {foreground: "#9DF39F"}},
   {name: "css property-value;",
    scope: 
     "meta.property-group support.constant.property-value.css, meta.property-value support.constant.property-value.css",
    settings: {foreground: "#F6F080"}},
   {name: "css @at-rule",
    scope: "meta.preprocessor.at-rule keyword.control.at-rule",
    settings: {foreground: "#F6AA11"}},
   {name: "css additional-constants",
    scope: 
     "meta.property-value support.constant.named-color.css, meta.property-value constant",
    settings: {foreground: "#EDF080"}},
   {name: "css constructor.argument",
    scope: "meta.constructor.argument.css",
    settings: {foreground: "#EB939A"}},
   {name: "diff.header",
    scope: "meta.diff, meta.diff.header",
    settings: {background: "#000E1A", fontStyle: "", foreground: "#F8F8F8"}},
   {name: "diff.deleted",
    scope: "markup.deleted",
    settings: {background: "#4C0900", foreground: "#F8F8F8"}},
   {name: "diff.changed",
    scope: "markup.changed",
    settings: {background: "#806F00", foreground: "#F8F8F8"}},
   {name: "diff.inserted",
    scope: "markup.inserted",
    settings: {background: "#154F00", foreground: "#F8F8F8"}},
   {name: "Raw Markup",
    scope: "markup.raw",
    settings: {background: "#8FDDF630"}},
   {name: "Block Quote",
    scope: "markup.quote",
    settings: {background: "#004480"}},
   {name: "List", scope: "markup.list", settings: {background: "#130D26"}},
   {name: "Bold Markup",
    scope: "markup.bold",
    settings: {fontStyle: "bold", foreground: "#C1AFFF"}},
   {name: "Italic Markup",
    scope: "markup.italic",
    settings: {fontStyle: "italic", foreground: "#B8FFD9"}},
   {name: "Heading Markup",
    scope: "markup.heading",
    settings: 
     {background: "#001221", fontStyle: "bold", foreground: "#C8E4FD"}}],
