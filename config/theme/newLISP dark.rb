...
{comment: "Ober (modified Sunburst)",
 name: "newLISP dark",
 settings: 
  [{settings: 
     {background: "#121212",
   ...
   {name: "Constant", scope: "constant", settings: {foreground: "#C68556"}},
   {name: "Entity",
    scope: "entity",
    settings: {fontStyle: "bold", foreground: "#E6E6E6"}},
   {name: "Keyword",
    scope: "keyword",
    settings: {fontStyle: "bold", foreground: "#66CCFF"}},
   {name: "Storage",
    scope: "storage",
    settings: {fontStyle: "bold", foreground: "#66CCFF"}},
   {name: "String",
    scope: "string",
    settings: {fontStyle: "", foreground: "#33D745"}},
   {name: "Support",
    scope: "support",
    settings: {fontStyle: "", foreground: "#66CCFF"}},
   {name: "Variable", scope: "variable", settings: {foreground: "#66CCFF"}},
   ...
   {name: "Invalid – Illegal",
    ...
    settings: {background: "#800000", foreground: "#FFFFFF"}},
   {name: "-----------------------------------", settings: {}},
   {name: "♦ Embedded Source (Bright)",
    scope: "text source",
    settings: {background: "#B1B3BA08"}},
   {name: "♦ Entity inherited-class",
    scope: "entity.other.inherited-class",
    settings: {fontStyle: "", foreground: "#A38345"}},
   {name: "♦ String embedded-source",
    scope: "string.quoted source",
    settings: {fontStyle: "", foreground: "#C68556"}},
   {name: "♦ String constant",
    scope: "string constant",
    settings: {fontStyle: "", foreground: "#C68556"}},
   {name: "♦ String.regexp",
    scope: "string.regexp",
    settings: {foreground: "#C68556"}},
   ...
   {name: "j Cast",
    scope: "meta.cast",
    settings: {fontStyle: "italic", foreground: "#676767"}},
   ...
   {name: "✘ Namespaces",
    ...
    settings: {fontStyle: "", foreground: "#FFCC66"}},
   {name: "§ css tag-name",
   ...
   {name: "§ css.class",
    ...
    settings: {fontStyle: "", foreground: "#E6E6E6"}},
   ...
   {name: "Markup: Italic",
    scope: "markup.italic",
    settings: {fontStyle: "italic", foreground: "#CB0202"}},
   {name: "Markup: Bold",
    scope: "markup.bold",
    settings: {fontStyle: "bold", foreground: "#CB0202"}},
   {name: "Markup: Underline",
    scope: "markup.underline",
    settings: {fontStyle: "underline", foreground: "#CB0202"}},
   {name: "Markup: Quote",
    scope: "markup.quote",
    settings: 
     {background: "#F8F7E4", fontStyle: "italic", foreground: "#408000"}},
   {name: "Markup: Heading",
    scope: "markup.heading, markup.heading entity",
    settings: {background: "#632D04", fontStyle: "", foreground: "#FEDCC5"}},
   {name: "Markup: List",
    scope: "markup.list",
    settings: {foreground: "#908978"}},
   {name: "Markup: Raw",
    scope: "markup.raw",
    settings: {background: "#B1B3BA08", fontStyle: "", foreground: "#66CCFF"}},
   {name: "Markup: Comment",
    scope: "markup comment",
    settings: {fontStyle: "italic", foreground: "#F67B37"}},
   {name: "Markup: Separator",
    scope: "meta.separator",
    settings: {background: "#242424", foreground: "#60A633"}},
   {name: "Log Entry",
    scope: "meta.line.entry.logfile, meta.line.exit.logfile",
    settings: {background: "#EEEEEE29"}},
   {name: "Log Entry Error",
    scope: "meta.line.error.logfile",
    settings: {background: "#751012"}},
   {name: "Namespace",
    scope: "namespace.lsp",
    settings: {background: "#94410A", fontStyle: "bold"}},
   {name: "Paren",
    scope: "paren.character.lsp",
    settings: {fontStyle: "", foreground: "#FFCC66"}},
   {name: "String Delimiter",
    scope: "punctuation.definition.string.lsp",
    settings: {fontStyle: "", foreground: "#33D745"}}],
 uuid: "F84360FD-BC2D-4567-B9D3-70C147F11E1B"}
