...
{author: "Jeroen van der Ham",
 ...
 settings: 
  [{settings: 
   ...
   {name: "Invalid",
    scope: "invalid",
    settings: {background: "#E71A114D", foreground: "#FF0000"}},
   {name: "Trailing whitespace",
    scope: "invalid.deprecated.trailing-whitespace",
    settings: {background: "#E71A1100"}},
   {name: "Embedded source",
    scope: "text source",
    settings: {background: "#FAFAFAFC", foreground: "#000000"}},
   {name: "Tag",
   ...
   {name: "Support",
    scope: "support",
    settings: {fontStyle: "bold", foreground: "#3333FF"}},
   ...
   {name: "Tag Attribute",
    ...
    settings: {fontStyle: "italic", foreground: "#3366CC"}},
   {name: "Tag Name",
