...
{author: "William D. Neumann",
 ...
 settings: 
  [{settings: 
   ...
   {name: "Comment",
    scope: "comment",
    settings: {fontStyle: "italic", foreground: "#709070"}},
   {name: "Directive",
   ...
   {name: "Language Keyword",
    scope: "keyword",
    settings: {foreground: "#FFFFA0"}},
   {name: "Module Keyword",
    scope: "entity.name.module,  support.other.module",
    settings: {fontStyle: "bold", foreground: "#FF8000"}},
   {name: "Operators",
   ...
   {name: "Storage Types",
    scope: "storage.type",
    settings: {foreground: "#6080FF"}},
   {name: "Variant Types",
    scope: "entity.name.class.variant",
    settings: {foreground: "#4080A0"}},
   {name: "Storage", scope: "storage", settings: {}},
   {name: "Type name",
    scope: "entity.name.type",
    settings: {foreground: "#F09040"}},
   {name: "Inherited class",
    scope: "entity.other.inherited-class",
    settings: {}},
   {name: "Function name",
    scope: "entity.name.function",
    settings: {fontStyle: "bold", foreground: "#FFCC66"}},
   {name: "Type name",
    scope: "storage.type.user-defined",
    settings: {foreground: "#FFE000"}},
   {name: "Class type name",
    scope: "entity.name.type.class.type",
    settings: {foreground: "#F4A020"}},
