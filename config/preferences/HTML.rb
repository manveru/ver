...
[{name: "Comments",
 ...
 {name: "Typing Pairs: Empty Tag",
  scope: "text.html invalid.illegal.incomplete",
  settings: {smartTypingPairs: [["?", "?"], ["%", "%"]]},
  uuid: "6D6B631D-0D6C-413C-B4FA-1D535CBCE890"},
 {name: "Miscellaneous",
  scope: "text.html",
  settings: 
   {decreaseIndentPattern: 
    ...
    smartTypingPairs: 
     [["\"", "\""],
      ...
      ["“", "”"],
      ["<", ">"]]},
  uuid: "FC34BE82-69DC-47B0-997A-37A8763D4E69"},
 {name: "Symbol List: ID",
  scope: "text.html meta.toc-list.id.html",
  settings: {symbolTransformation: "s/^/ID: /"},
 ...
 {name: "Completions HTML Attributes",
  scope: 
  ...
  settings: 
   {completions: 
    ...
    shellVariables: 
     [{name: "TM_COMPLETION_split", value: ","},
      {name: "TM_COMPLETION_scope", value: "html_attributes"},
      {name: "TM_COMPLETIONS",
       value: 
  ...
  uuid: "69BD9C8F-15C0-4F67-8B7E-64E48B5E9E71"},
 {name: "Completions HTML Tags",
  scope: 
  ...
  uuid: "4720ADB8-DD17-4F97-A715-AFD72E22CE45"}]
