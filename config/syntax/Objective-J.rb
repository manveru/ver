...
{fileTypes: ["j", "J"],
 ...
 patterns: 
  [{begin: 
    ...
    patterns: 
     [{include: "#protocol_list"}, {include: "#method"}, {include: "$base"}]},
   {begin: 
   ...
   {begin: /@"/,
    beginCaptures: 
     {0 => {name: "punctuation.definition.string.begin.js.objj"}},
    end: "\"",
 ...
 repository: 
  {bracketed_content: 
    {begin: /\[/,
     captures: {0 => {name: "punctuation.section.scope.js.objj"}},
     end: "\\]",
   ...
   comment: 
    {patterns: 
      [{begin: /\/\*/,
       ...
       {begin: /\/\//,
        beginCaptures: {0 => {name: "punctuation.definition.comment.js.objj"}},
        end: "$\\n?",
 ...
 uuid: "58D4B98A-2110-423E-9C80-CC9E202816E7"}
