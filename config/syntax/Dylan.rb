...
{fileTypes: ["dylan"],
 ...
 patterns: 
  [{begin: /\/\*/,
   ...
   {begin: 
     /\b(define\s+)((?:sealed|inline)\s)?(method|function)\s+([A-Za-z0-9\\-]*[!?]?)\s/,
    captures: 
   ...
   {match: 
     /\b(?<!-)(begin|block|case|class|constant|define|domain|else|end|for|function|handler|if|inline|let|library|local|macro|method|module|otherwise|select|unless|until|variable|when|while)(?![:-])\b/,
