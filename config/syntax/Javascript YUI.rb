...
{comment: "Yahoo User Interface Library 2.8.0",
 ...
 patterns: 
  [{match: /\b(YAHOO|YAHOO_config)\b/, name: "support.class.js.yui"},
   ...
   {match: /\.(getPosition)\b(?=\()/, name: "support.function.Bezier.js.yui"},
   {match: /\.(parseColor)\b(?=\()/,
   ...
   {match: /\.()\b(?=\()/, name: "support.function.Motion.js.yui"},
   {match: /\.()\b(?=\()/, name: "support.function.Scroll.js.yui"},
   {match: 
   ...
   {match: /\.()\b(?=\()/, name: "support.function.DS_JSArray.js.yui"},
   {match: /\.()\b(?=\()/, name: "support.function.DS_JSFunction.js.yui"},
   ...
   {match: /\.()\b(?=\()/, name: "support.function.LogMsg.js.yui"},
   {match: 
   ...
   {match: /\.(init)\b(?=\()/, name: "support.function.MenuBarItem.js.yui"},
   {match: 
   ...
   {match: /\.()\b(?=\()/, name: "support.function.MenuModule.js.yui"},
   {match: /\.()\b(?=\()/, name: "support.function.MenuModuleItem.js.yui"},
   ...
   {match: /\.(initAttributes)\b(?=\()/, name: "support.function.Tab.js.yui"},
   {match: 
   ...
   {match: /\.()\b(?=\()/, name: "support.function.MenuNode.js.yui"},
   {match: /\.(getLabelEl|onLabelClick)\b(?=\()/,
    name: "support.function.TextNode.js.yui"},
   {match: /\.()\b(?=\()/, name: "support.function.RootNode.js.yui"},
   ...
   {match: /\.()\b(?=\()/, name: "support.function.ColumnSet.js.yui"},
   {match: 
   ...
   {match: /\.()\b(?=\()/, name: "support.function.Record.js.yui"},
   {match: 
