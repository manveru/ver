...
{fileTypes: [],
 ...
 patterns: 
  [{begin: /(?<=\{)\*/,
   ...
   {match: /\b(and|or)\b/, name: "keyword.operator.smarty"},
   ...
   {captures: {1 => {name: "punctuation.definition.variable.smarty"}},
    match: /(\$)[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*?\b/n,
    name: "variable.other.smarty"},
   {match: /\b(TRUE|FALSE|true|false)\b/, name: "constant.language.smarty"}],
