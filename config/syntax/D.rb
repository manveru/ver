...
{comment: "D language",
 ...
 patterns: 
  [{captures: {0 => {name: "punctuation.definition.comment.d"}},
   ...
   {match: /(\-|\+|\*|\/|~|%)/, name: "keyword.operator.arithmetic.d"},
   ...
   {match: /\b(new|throws)\b/, name: "keyword.other.class-fns.d"},
   {match: /\b(package|extern)\b/, name: "keyword.other.external.d"},
   {match: /\b(deprecated|unittest|debug)\b/, name: "keyword.other.debug.d"},
   {match: 
 ...
 repository: 
  {:"all-types" => 
   ...
   :"support-type-d" => 
    {match: /\b((?:tango|std)\.[\w\.]+)\b/, name: "support.type.d"}},
 scopeName: "source.d",
