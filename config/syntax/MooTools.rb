...
{comment: 
 ...
 patterns: 
  [{comment: 
   ...
   {match: /\b(extend|Native)\b/, name: "support.function.class.js.mootools"},
   {comment: 
    ...
    patterns: 
     [{include: "#element-functions"},
      ...
      {begin: /(\{)/,
       ...
       endCaptures: {1 => {name: "punctuation.definition.parameters.end.js"}},
       patterns: 
        [{match: /(:)/, name: "punctuation.separator.key-value.js.mootools"},
         {include: "#fx-options"},
         {include: "source.js"}]}]},
   {comment: 
      ...
      {begin: /,\s*(\{)/,
       ...
       patterns: 
        [{match: /(:)/, name: "punctuation.separator.key-value.js.mootools"},
         {include: "#fx-options"},
         {include: "source.js"}]}]},
   {match: /\b(effect)\b/, name: "support.class.element.js.mootools"},
   {comment: 
      ...
      {begin: /(\{)/,
       ...
       patterns: 
        [{match: /(:)/, name: "punctuation.separator.key-value.js.mootools"},
         {include: "#fx-options"},
         {include: "source.js"}]}]},
   {match: /\b(effects)\b/, name: "support.class.element.js.mootools"},
   {comment: 
