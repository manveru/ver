...
{fileTypes: ["as"],
 ...
 patterns: 
  [{match: 
   ...
   {begin: /"/,
    beginCaptures: 
     {0 => {name: "punctuation.definition.string.begin.actionscript.2"}},
    end: "\"",
    endCaptures: 
     {0 => {name: "punctuation.definition.string.end.actionscript.2"}},
    name: "string.quoted.double.actionscript.2",
    patterns: 
     [{match: /\\./, name: "constant.character.escape.actionscript.2"}]},
   {begin: /'/,
    beginCaptures: 
     {0 => {name: "punctuation.definition.string.begin.actionscript.2"}},
    end: "'",
   ...
   {match: 
    ...
    name: "support.constant.actionscript.2"},
   {begin: /\/\*/,
    captures: {0 => {name: "punctuation.definition.comment.actionscript.2"}},
    end: "\\*/",
   ...
   {captures: 
     {1 => {name: "punctuation.definition.preprocessor.actionscript.2"}},
    match: /^[ \t]*(#)[a-zA-Z]+/,
    name: "meta.preprocessor.actionscript.2"},
   {begin: /\b(function)\s+([a-zA-Z_]\w*)\s*(\()/,
    captures: 
     {1 => {name: "storage.type.function.actionscript.2"},
      2 => {name: "entity.name.function.actionscript.2"},
      3 => {name: "punctuation.definition.parameters.begin.actionscript.2"}},
    end: "\\)",
    endCaptures: 
     {0 => {name: "punctuation.definition.parameters.end.actionscript.2"}},
    name: "meta.function.actionscript.2",
    patterns: 
     [{match: /[^,)\n]+/,
       name: "variable.parameter.function.actionscript.2"}]},
   {captures: 
     {1 => {name: "storage.type.class.actionscript.2"},
