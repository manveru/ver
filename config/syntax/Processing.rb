...
{fileTypes: ["pde"],
 ...
 patterns: 
  [{match: 
   ...
   {begin: /\/\*\*/,
    ...
    patterns: 
     [{captures: 
       ...
       match: /\*\s*@(?<_1>param)\s*(?<_2>[a-z][a-zA-Z0-9_]+)\s*/},
      {captures: 
   ...
   {match: /\b(?<_1>import|new|package|throws)\b/,
    name: "keyword.other.class-fns.processing"},
   {match: /\b(?<_1>instanceof)\b/, name: "keyword.operator.processing"},
   {match: /\b(?<_1>false|null|true)\b/, name: "constant.language.processing"},
   {match: 
   ...
   {match: /\b(?<_1>this|super)\b/, name: "variable.language.processing"},
   {match: 
