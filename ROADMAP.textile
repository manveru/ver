...
Given a file in a buffer, it should have an associated project directory.
This can be used for things like FuzzFileFinder or grepping.
Automatic detection can be done by searching for /.git, /_darcs, or /__FOSSIL__
...
Using the soma gem, just add some keybinds to pipe buffer or selection to soma.
