...
h2. Proper indentation support

At the moment, all we do is maintain indentation when possible.
But it would be nice if VER could use the information from bundles for that.
The last attempt had way too much slow backtracking, so I removed it.
...
p YARD::Registry.at('VER').docstring
}}}
